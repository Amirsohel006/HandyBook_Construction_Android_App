package com.example.handybook_construction_android_app.proffesionaldetailsfragment
...
import com.example.handybook_construction_android_app.professional_fragment.ProfessionalAdapter
 ...
 * Use the [ProffessionalsDetailsFragment.newInstance] factory method to
...
class ProffessionalsDetailsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProffessionalsDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProffessionalsDetailsFragment().apply {
